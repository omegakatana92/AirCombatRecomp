...
A modern fan-made recompilation project for **Air Combat**, originally released for the **Sony PlayStation**.

## Disc Required

This project **does not include the original game disc image or copyrighted assets**.

To play, you must provide your **own legally obtained copy** of *Air Combat*.
...
```bash
git clone https://github.com/omegakatana92/AirCombatRecomp.git
cd AirCombatRecomp
```
...
**Air Combat**, its characters, names, artwork, music, trademarks, and other intellectual property remain the property of their respective copyright and trademark holders.
